            ...
            return Room.databaseBuilder(context.applicationContext, AppDatabase::class.java, DB_NAME)
                .addCallback(object: RoomDatabase.Callback() {
                    override fun onCreate(db: SupportSQLiteDatabase) {
                        ...
                        for(i in 0..21) {
                            db.execSQL("insert into VideoDB (uploadUserSeq, title, contents, thumbnailPath, videoPath, likeCount, notLikeCount, replyCount, viewCount, uploadDate) values ($i, '$i 번이 올린 비디오 1', '$i 번이 올린 비디오 내용 1', 'http://data-dev.earlybird.ai:80/image/news/base/202008/18_173ff5638ea4fe1f.jpg', 'http://cache.midibus.kinxcdn.com/hls/ch_171e807a/173ff5638ea4fe1f/playlist.m3u8', 572, 13, 5, 123897132, ${System.currentTimeMillis()})")
                            db.execSQL("insert into VideoDB (uploadUserSeq, title, contents, thumbnailPath, videoPath, likeCount, notLikeCount, replyCount, viewCount, uploadDate) values ($i, '$i 번이 올린 비디오 2', '$i 번이 올린 비디오 내용 2', 'http://data-dev.earlybird.ai:80/image/news/base/202008/18_173ff5638ea4fe1f.jpg', 'http://cache.midibus.kinxcdn.com/hls/ch_171e807a/173ff5638ea4fe1f/playlist.m3u8', 572, 13, 5, 9832, ${System.currentTimeMillis()})")
                            db.execSQL("insert into VideoDB (uploadUserSeq, title, contents, thumbnailPath, videoPath, likeCount, notLikeCount, replyCount, viewCount, uploadDate) values ($i, '$i 번이 올린 비디오 3', '$i 번이 올린 비디오 내용 3', 'http://data-dev.earlybird.ai:80/image/news/base/202008/18_173ff5638ea4fe1f.jpg', 'http://cache.midibus.kinxcdn.com/hls/ch_171e807a/173ff5638ea4fe1f/playlist.m3u8', 572, 13, 5, 8392374, ${System.currentTimeMillis()})")
                        }
